...
describe("default configuration", () => {
    ...
    test("check_run.inProgress", async () => {
        expect(DEFAULT_CONFIG.check_run.inProgress).toEqual({ status: "in_progress" })
    })

    test("check_run.success", async () => {
        expect(DEFAULT_CONFIG.check_run.success).toEqual(expect.objectContaining({
            status: "completed",
            conclusion: "success",
    ...
    test("check_run.failure", async () => {
        expect(DEFAULT_CONFIG.check_run.failure).toEqual(expect.objectContaining({
            status: "completed",
            conclusion: "failure",
            output: expect.anything()
        }))
